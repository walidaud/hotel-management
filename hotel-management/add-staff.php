...
if(isset($_POST["submit"])){
    ...
    if ($first_name != "" && $last_name != "" && $phone_number != "" && $email != "" && $address != "" && $city != "" && $country != "" && $hotel_id != "" && $position != ""){

        $query = "INSERT INTO `STAFF` (`StaffFirstName`, `StaffLastName`, `StaffPhoneNumber`, `StaffEmail`, `StaffAddress`, `StaffCity`, `StaffCountry`, `HotelID`, `Position`) VALUES
                ('$first_name', '$last_name', '$phone_number', '$email', '$address', '$city', '$country', '$hotel_id', '$position')";
...
<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header" style="margin-top:150px; margin-left:780px;">Register New Staff</h1>
        </div>
    </div>
    ...
    <input type="number" name="hotel_id" class="form-control" style="width: 500px;" min="1">
    </div>
